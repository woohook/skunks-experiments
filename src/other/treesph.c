...
float h1,h2,r,r0,tt0,x1,x2,x3,y1,y2,y3,z1,z2,z3;
FILE *f;
...
for(i=1;i<=n;i++){
  x1=h1+h2*frand1();
  r0=sqrt(r*r-(h1+0.5*h2-x1)*(h1+0.5*h2-x1))*frand1(); tt0=6.283*frand1();
  y1=r0*cos(tt0); z1=r0*sin(tt0);
    x2=h1+h2*frand1();
    r0=sqrt(r*r-(h1+0.5*h2-x2)*(h1+0.5*h2-x2))*frand1(); tt0=6.283*frand1();
    y2=r0*cos(tt0); z2=r0*sin(tt0);
  x3=h1+h2*frand1();
  r0=sqrt(r*r-(h1+0.5*h2-x3)*(h1+0.5*h2-x3))*frand1(); tt0=6.283*frand1();
